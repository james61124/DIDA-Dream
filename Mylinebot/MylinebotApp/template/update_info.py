...
def line_liff_id(uid):
    ...
    datas = {
        "view": {
            "type": "tall",
            "url": "https://2022.dida-dream.com/redirect.php?uid="+str(uid)+"&flag=em"
        },
...
def line_liff_id_shop(uid):
    ...
    datas = {
        ...
        "description": "update_info_to_shop"+str(uid),
        "features": {
            "ble": True,
            "qrCode": True
        },
                  ...
                  "contents": [
                        ...
                        "footer": {
                            ...
                            "contents": [
                            {
                                ...
                                "type": "uri",
                                "label": "修改偏好設定",
                                "uri": "https://liff.line.me/1657635549-aQLE3y2P" #+line_liff_id(uid)
                                }
                            },
                            {
                                "type": "button",
                                ...
                                "type": "uri",
                                "label": "註冊成為商家",
                                "uri": "https://liff.line.me/"+line_liff_id_shop(uid)
                                }
                            },
                            {
                                "type": "box",
